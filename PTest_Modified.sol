...
contract PTEST is ERC20, Ownable {
    ...
    constructor(address feeWallet, address _newOwner, uint256 _totalSupply, uint256 _buyFee, uint256 _sellFee, string memory _name, string memory _symbol, uint8 _decimals)
    ...
    function updateFees(uint256 s_buyFee, uint256 s_sellFee) external {
        ...
        uint256 totalFees = s_buyFee + s_sellFee;
        require (totalFees < 10, "Exceeded Maximum Fees limit");
